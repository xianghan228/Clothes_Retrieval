...
if __name__ =='__main__':
    def parse_args():
      ...
      parser.add_argument('--base_path_name',     default='/data1/qtang/samsung/org_part/result/ap',help='')
      parser.add_argument('--pkl_path',           default='/data1/qtang/samsung/org_part/result/pkl',help='')
      ...
      parser.add_argument('--query_feat_path',    default='/data1/qtang/samsung/org_part/feat_query33ali/iter6000/fc8',help='')
      parser.add_argument('--eval_feat_path',     default='/data1/qtang/samsung/org_part/feat_eva33ali298/iter6000/fc8',help='')
      parser.add_argument('--name_flag',          default='iter6000_ali298_fc8_org_part',help='such as 68_v1_6000')
      parser.add_argument('--distance_pkl_path',   default='/data1/qtang/samsung/org_part/result/dis/distance_pkl_',help='')
