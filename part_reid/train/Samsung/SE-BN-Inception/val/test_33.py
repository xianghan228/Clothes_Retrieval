...
if __name__ =='__main__':
    def parse_args():
      ...
      parser.add_argument('--query_feat_path',    default='./feat_query33_baseline/iter90000/concat_attr_pca/1.2',help='')
      parser.add_argument('--eval_feat_path',     default='./feat_evalib33_baseline/iter90000/concat_attr_pca/1.2',help='')
      parser.add_argument('--name_flag',          default='iter90000_lib_33_baseline_concat_attr_1.2',help='such as 68_v1_10000')
      parser.add_argument('--distance_pkl_path',   default='./result/dis/33/distance_pkl_',help='')
      parser.add_argument('--save_result_txt',     default='result_baseline_concat.txt',help='such as result.txt') 
