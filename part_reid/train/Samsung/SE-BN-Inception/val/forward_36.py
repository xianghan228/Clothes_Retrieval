...
if __name__ == '__main__':
  for i in [80000]:
    feat_extract(img_list_path='./evaLib36.txt',model='../train/snapshot/model_iter_%d.caffemodel'%i,iter=i,flag='_baseline')
    feat_extract(img_list_path='./evalib36.txt',model='../train/snapshot/model_iter_%d.caffemodel'%i,iter=i,flag='_baseline')
    feat_extract(img_list_path='./query36.txt',model='../train/snapshot/model_iter_%d.caffemodel'%i,iter=i,flag='_baseline')
