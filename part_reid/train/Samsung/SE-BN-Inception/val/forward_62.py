...
if __name__ == '__main__':
  for i in [80000]:
    feat_extract(img_list_path='./evaLib62.txt',model='../train/snapshot/model_iter_%d.caffemodel'%i,iter=i,flag='_baseline')
    feat_extract(img_list_path='./evalib62.txt',model='../train/snapshot/model_iter_%d.caffemodel'%i,iter=i,flag='_baseline')
    feat_extract(img_list_path='./query62.txt',model='../train/snapshot/model_iter_%d.caffemodel'%i,iter=i,flag='_baseline')
