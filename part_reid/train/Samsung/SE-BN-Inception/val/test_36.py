...
if __name__ =='__main__':
    def parse_args():
      ...
      parser.add_argument('--query_feat_path',    default='./feat_query36_baseline/iter80000/normed_feature',help='')
      parser.add_argument('--eval_feat_path',     default='./feat_evaLib36_baseline/iter80000/normed_feature',help='')
      parser.add_argument('--name_flag',          default='iter80000_Lib_36_baseline_update',help='such as 68_v1_10000')
