...
/data1/zwshen/samsung/part_reid/caffe/build/tools/caffe train -solver solver.prototxt -weights /data1/zwshen/samsung/part_reid/models/basenet/googlenet/bvlc_googlenet.caffemodel -gpu 0
