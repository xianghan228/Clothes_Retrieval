...
if __name__ == '__main__':
  for i in [85000]:
    feat_extract(img_list_path='./evaLib36.txt',model='../snapshot_with_neg/model_iter_%d.caffemodel'%i,iter=i,flag='_old_top20')
    feat_extract(img_list_path='./evalib36.txt',model='../snapshot_with_neg/model_iter_%d.caffemodel'%i,iter=i,flag='_old_top20')
    feat_extract(img_list_path='./query36.txt',model='../snapshot_with_neg/model_iter_%d.caffemodel'%i,iter=i,flag='_old_top20')
