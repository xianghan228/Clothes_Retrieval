...
import numpy as np
import pdb
base_path = '/data1/qtang/samsung/part_reid/train/Samsung/alidfcd_ivabox_partnet/val/result/pkl'
sub_paths  = ['33/iter85000_Lib_33','36/iter85000_Lib_36','62/iter85000_Lib_62']
q_neg = {}
