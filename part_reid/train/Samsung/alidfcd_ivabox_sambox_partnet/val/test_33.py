...
if __name__ =='__main__':
    def parse_args():
      ...
      parser.add_argument('--query_feat_path',    default='./feat_query33_with_neg/iter85000/normed_feature',help='')
      parser.add_argument('--eval_feat_path',     default='./feat_evalib33_with_neg/iter85000/normed_feature',help='')
      parser.add_argument('--name_flag',          default='iter85000_lib_33_with_neg',help='such as 68_v1_10000')
