...
import os
import numpy as np
def feat_extract(device_id=7, img_list_path='', batchsize=280, net='./deploy_2.prototxt', model='../snapshot_with_neg/model_iter_55000.caffemodel', iter=55000 , blob='normed_feature'):
...
if __name__ == '__main__':
  #for i in [60000,65000,95000,100000]:
    feat_extract(img_list_path='./evaLib33.txt',model='../snapshot_with_neg/model_iter_85000.caffemodel',iter=85000)
    #feat_extract(img_list_path='./query33.txt',model='../snapshot_with_neg/model_iter_95000.caffemodel',iter=95000)
