...
if __name__ == '__main__':
  for i in [85000]:
    feat_extract(img_list_path='./evaLib33.txt',model='../snapshot_with_neg/model_iter_%d.caffemodel'%i,iter=i,flag='_old_top20')
    feat_extract(img_list_path='./evalib33.txt',model='../snapshot_with_neg/model_iter_%d.caffemodel'%i,iter=i,flag='_old_top20')
    feat_extract(img_list_path='./query33.txt',model='../snapshot_with_neg/model_iter_%d.caffemodel'%i,iter=i,flag='_old_top20')
