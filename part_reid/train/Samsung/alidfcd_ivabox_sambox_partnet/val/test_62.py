...
if __name__ =='__main__':
    def parse_args():
      ...
      parser.add_argument('--query_txt_path',     default='./query_gt_62.txt',help='')
      parser.add_argument('--pickled_img_pkl_path',default='/data1/zwshen/samsung/intermediate/33_pickled_img.pkl',help='')
      parser.add_argument('--query_feat_path',    default='./feat_query62_with_neg/iter85000/normed_feature',help='')
      parser.add_argument('--eval_feat_path',     default='./feat_evalib62_with_neg/iter85000/normed_feature',help='')
      parser.add_argument('--name_flag',          default='iter85000_lib_62_with_neg',help='such as 68_v1_10000')
