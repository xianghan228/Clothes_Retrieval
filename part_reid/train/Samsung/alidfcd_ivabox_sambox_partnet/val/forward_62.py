...
if __name__ == '__main__':
  for i in [85000]:
    feat_extract(img_list_path='./evaLib62.txt',model='../snapshot_with_neg/model_iter_%d.caffemodel'%i,iter=i,flag='_old_top20')
    feat_extract(img_list_path='./evalib62.txt',model='../snapshot_with_neg/model_iter_%d.caffemodel'%i,iter=i,flag='_old_top20')
    feat_extract(img_list_path='./query62.txt',model='../snapshot_with_neg/model_iter_%d.caffemodel'%i,iter=i,flag='_old_top20')
