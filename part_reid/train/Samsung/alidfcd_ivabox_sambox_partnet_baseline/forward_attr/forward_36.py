...
if __name__ == '__main__':
  for i in [75000]:
    feat_extract(img_list_path='../../SE-BN-Inception/val/evaLib36.txt',model='./attr.caffemodel',iter=i,flag='_atrr')
    feat_extract(img_list_path='../../SE-BN-Inception/val/evalib36.txt',model='./attr.caffemodel',iter=i,flag='_attr')
    feat_extract(img_list_path='../../SE-BN-Inception/val/query36.txt',model='./attr.caffemodel',iter=i,flag='_attr')
