...
if __name__ == '__main__':
  for i in [75000]:
    feat_extract(img_list_path='../val/evaLib33.txt',model='./attr.caffemodel',iter=i,flag='_attr')
    feat_extract(img_list_path='../val/evalib33.txt',model='./attr.caffemodel',iter=i,flag='_attr')
    feat_extract(img_list_path='../val/query33.txt',model='./attr.caffemodel',iter=i,flag='_attr')
