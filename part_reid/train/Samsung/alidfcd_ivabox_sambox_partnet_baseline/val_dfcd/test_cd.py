...
def calculate_distance_multi_img(retrieved_img_info_dict,distance_pkl_path,feat_npz_path_list):
    ...
    for npz_i_idx,npz_i in enumerate(feat_npz_path_list):
        ...
        distance_dict['distance'].append(sorted_dist_mat[:,:5])
        distance_dict['sortedIndex'].append(sortedIndex_mat[:,:5])
        distance_dict['eval_img'].append(npz['img'])
        del npz
        del npz_i
        del eval_feats
        del retrieved_img_feat
        del dist
        del sortedIndex_mat
        del sorted_dist_mat
        print gc.collect()
...
if __name__ =='__main__':
    def parse_args():
      ...
      parser.add_argument('--pkl_path',           default='./result/pkl/cd',help='')
      parser.add_argument('--query_txt_path',     default='./query_gt_cd.txt',help='')
      parser.add_argument('--pickled_img_pkl_path',default='/data1/zwshen/samsung/intermediate/33_pickled_img.pkl',help='')
      parser.add_argument('--query_feat_path',    default='./feat_query_cd/normed_feature',help='')
      parser.add_argument('--eval_feat_path',     default='./feat_evaLib_1/normed_feature',help='')
      parser.add_argument('--name_flag',          default='cd_Lib',help='such as 68_v1_10000')
      parser.add_argument('--distance_pkl_path',   default='./result/dis/cd/distance_pkl_',help='')
