...
if __name__ =='__main__':
      def parse_args():
        ...
        parser.add_argument('--query_feat_path',    default='./feat_query36_top40/iter75000/concat_feature/0.4',help='')
        parser.add_argument('--eval_feat_path',     default='./feat_evaLib36_top40/iter75000/concat_feature/0.4',help='')
        parser.add_argument('--name_flag',          default='iter75000_Lib_36_top40_concat_0.4_new',help='such as 68_v1_10000')
        parser.add_argument('--distance_pkl_path',   default='./result/dis/36/distance_pkl_',help='')
        parser.add_argument('--save_result_txt',     default='result_concate.txt',help='such as result.txt') 
