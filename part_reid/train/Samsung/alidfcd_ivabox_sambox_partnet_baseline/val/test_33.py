...
if __name__ =='__main__':
    def parse_args():
      ...
      parser.add_argument('--pkl_path',           default='./result/pkl/33',help='')
      parser.add_argument('--query_txt_path',     default='./query_gt_33_new.txt',help='')
      parser.add_argument('--pickled_img_pkl_path',default='/data1/zwshen/samsung/intermediate/33_pickled_img.pkl',help='')
      parser.add_argument('--query_feat_path',    default='./feat_query33_top40_qf_senet/iter80000/concat_all_pca/0.4',help='')
      parser.add_argument('--eval_feat_path',     default='./feat_evalib33_top40_qf_senet/iter80000/concat_all_pca/0.4',help='')
      parser.add_argument('--name_flag',          default='iter80000_lib_33_top40_qf_senet_concat_all_pca__1:1.2:0.4',help='such as 68_v1_10000')
      parser.add_argument('--distance_pkl_path',   default='./result/dis/33/distance_pkl_',help='')
