...
if __name__ =='__main__':
    def parse_args():
      ...
      parser.add_argument('--query_txt_path',     default='./query_gt_33.txt',help='')
      parser.add_argument('--pickled_img_pkl_path',default='/data1/zwshen/samsung/intermediate/33_pickled_img.pkl',help='')
      parser.add_argument('--query_feat_path',    default='./feat_query33_top40/iter75000/concat_feature/1.4',help='')
      parser.add_argument('--eval_feat_path',     default='./feat_evaLib33_top40/iter75000/concat_feature/1.4',help='')
      parser.add_argument('--name_flag',          default='iter75000_Lib_33_top40_concat_1.4',help='such as 68_v1_10000')
