...
if __name__ == '__main__':
  for i in [90000,95000,100000]:
    feat_extract(img_list_path='./evaLib62.txt',model='../snapshot_dfcd_neg20/model_iter_%d.caffemodel'%i,iter=i,flag='_dfcd_top20')
    feat_extract(img_list_path='./evalib62.txt',model='../snapshot_dfcd_neg20/model_iter_%d.caffemodel'%i,iter=i,flag='_dfcd_top20')
    feat_extract(img_list_path='./query62.txt',model='../snapshot_dfcd_neg20/model_iter_%d.caffemodel'%i,iter=i,flag='_dfcd_top20')
