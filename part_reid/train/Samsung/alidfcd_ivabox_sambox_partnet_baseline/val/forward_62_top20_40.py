...
if __name__ == '__main__':
  ...
  for i in [75000,80000,85000,90000,95000,100000]:
    feat_extract(img_list_path='./evaLib62.txt',model='../snapshot_baseline_top20/model_iter_%d.caffemodel'%i,iter=i,flag='_top20')
    feat_extract(img_list_path='./evalib62.txt',model='../snapshot_baseline_top20/model_iter_%d.caffemodel'%i,iter=i,flag='_top20')
    feat_extract(img_list_path='./query62.txt',model='../snapshot_baseline_top20/model_iter_%d.caffemodel'%i,iter=i,flag='_top20')
  
    feat_extract(img_list_path='./evaLib62.txt',model='../snapshot_baseline_top40/model_iter_%d.caffemodel'%i,iter=i,flag='_top40')
    feat_extract(img_list_path='./evalib62.txt',model='../snapshot_baseline_top40/model_iter_%d.caffemodel'%i,iter=i,flag='_top40')
    feat_extract(img_list_path='./query62.txt',model='../snapshot_baseline_top40/model_iter_%d.caffemodel'%i,iter=i,flag='_top40')
