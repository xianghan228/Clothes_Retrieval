...
if __name__ =='__main__':
    def parse_args():
      ...
      parser.add_argument('--pkl_path',           default='./result/pkl/36',help='')
      parser.add_argument('--query_txt_path',     default='./query_gt_36_new.txt',help='')
      parser.add_argument('--pickled_img_pkl_path',default='/data1/zwshen/samsung/intermediate/36_pickled_img.pkl',help='')
      parser.add_argument('--query_feat_path',    default='./feat_query36_top40_qf_senet/iter80000/concat_all_pca/0.4',help='')
      parser.add_argument('--eval_feat_path',     default='./feat_evalib36_top40_qf_senet/iter80000/concat_all_pca/0.4',help='')
      parser.add_argument('--name_flag',          default='iter80000_lib_36_top40_qf_senet_concat_all_pca_1:0.4:0.4',help='such as 68_v1_10000')
      parser.add_argument('--distance_pkl_path',   default='./result/dis/36/distance_pkl_',help='')
      parser.add_argument('--save_result_txt',     default='result_concat_pca.txt',help='such as result.txt') 
