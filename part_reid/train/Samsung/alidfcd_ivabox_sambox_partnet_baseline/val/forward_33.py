...
if __name__ == '__main__':
  ...
  for i in [75000,80000,85000,90000]:
    feat_extract(img_list_path='./evaLib33.txt',model='../snapshot_baseline_top40_qf_senet/model_iter_%d.caffemodel'%i,iter=i,flag='_top40_qf_senet')
    feat_extract(img_list_path='./evalib33.txt',model='../snapshot_baseline_top40_qf_senet/model_iter_%d.caffemodel'%i,iter=i,flag='_top40_qf_senet')
    feat_extract(img_list_path='./query33.txt',model='../snapshot_baseline_top40_qf_senet/model_iter_%d.caffemodel'%i,iter=i,flag='_top40_qf_senet')
    feat_extract(img_list_path='./evaLib33.txt',model='../snapshot_baseline_top40_qf/model_iter_%d.caffemodel'%i,iter=i,flag='_top40_qf')
    feat_extract(img_list_path='./evalib33.txt',model='../snapshot_baseline_top40_qf/model_iter_%d.caffemodel'%i,iter=i,flag='_top40_qf')
    feat_extract(img_list_path='./query33.txt',model='../snapshot_baseline_top40_qf/model_iter_%d.caffemodel'%i,iter=i,flag='_top40_qf')
