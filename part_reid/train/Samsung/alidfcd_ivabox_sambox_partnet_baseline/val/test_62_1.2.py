...
if __name__ =='__main__':
    def parse_args():
      ...
      parser.add_argument('--query_feat_path',    default='./feat_query62_top40/iter75000/concat_feature/0.4',help='')
      parser.add_argument('--eval_feat_path',     default='./feat_evaLib62_top40/iter75000/concat_feature/0.4',help='')
      parser.add_argument('--name_flag',          default='iter75000_Lib_62_top40_concat_0.4_new',help='such as 68_v1_10000')
