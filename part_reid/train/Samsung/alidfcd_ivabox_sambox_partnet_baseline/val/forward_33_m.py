...
if __name__ == '__main__':
  for i in [95000]:
    feat_extract(img_list_path='./evaLib33.txt',model='../snapshot_dfcd_neg20/model_iter_%d.caffemodel'%i,iter=i,flag='_dfcd_top20')
    feat_extract(img_list_path='./evalib33.txt',model='../snapshot_dfcd_neg20/model_iter_%d.caffemodel'%i,iter=i,flag='_dfcd_top20')
    feat_extract(img_list_path='./query33.txt',model='../snapshot_dfcd_neg20/model_iter_%d.caffemodel'%i,iter=i,flag='_dfcd_top20')
