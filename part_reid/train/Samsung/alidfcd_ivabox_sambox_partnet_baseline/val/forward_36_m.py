...
if __name__ == '__main__':
  for i in [95000,10000]:
    feat_extract(img_list_path='./evaLib36.txt',model='../snapshot_dfcd_neg20/model_iter_%d.caffemodel'%i,iter=i,flag='_dfcd_top20')
    feat_extract(img_list_path='./evalib36.txt',model='../snapshot_dfcd_neg20/model_iter_%d.caffemodel'%i,iter=i,flag='_dfcd_top20')
    feat_extract(img_list_path='./query36.txt',model='../snapshot_dfcd_neg20/model_iter_%d.caffemodel'%i,iter=i,flag='_dfcd_top20')
