...
if __name__ =='__main__':
    def parse_args():
      ...
      parser.add_argument('--query_feat_path',    default='./feat_query62_top40_qf_senet/iter80000/concat_all_pca/0.4',help='')
      parser.add_argument('--eval_feat_path',     default='./feat_evalib62_top40_qf_senet/iter80000/concat_all_pca/0.4',help='')
      parser.add_argument('--name_flag',          default='iter80000_lib_62_qf_senet_concat_all_pca_1:0.4:0.4',help='such as 68_v1_10000')
