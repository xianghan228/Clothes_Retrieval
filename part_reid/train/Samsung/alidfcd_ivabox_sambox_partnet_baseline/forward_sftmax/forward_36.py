...
if __name__ == '__main__':
  for i in [75000]:
    feat_extract(img_list_path='../val/evaLib36.txt',model='./36.caffemodel',iter=i,flag='_sftmax')
    feat_extract(img_list_path='../val/evalib36.txt',model='./36.caffemodel',iter=i,flag='_sftmax')
    feat_extract(img_list_path='../val/query36.txt',model='./36.caffemodel',iter=i,flag='_sftmax')
