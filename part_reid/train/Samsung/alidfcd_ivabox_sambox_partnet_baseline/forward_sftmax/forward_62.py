...
if __name__ == '__main__':
  for i in [75000]:
    feat_extract(img_list_path='../val/evaLib62.txt',model='./62.caffemodel',iter=i,flag='_sftmax')
    feat_extract(img_list_path='../val/evalib62.txt',model='./62.caffemodel',iter=i,flag='_sftmax')
    feat_extract(img_list_path='../val/query62.txt',model='./62.caffemodel',iter=i,flag='_sftmax')
