...
def img_ap(pkl_path,save_csv_path,name_flag=''):
    ...
    for pkl_idx,pkl in enumerate( pkl_list):
        ...
        AP_csv_top.iloc[pkl_idx,1]=cal_top(path,n=1)
...
if __name__ =='__main__':
    def parse_args():
      ...
      parser.add_argument('--pkl_path',           default='./result/pkl',help='')
      ...
      parser.add_argument('--query_feat_path',    default='./feat_query33ali/iter500/pool6_lda',help='')
      parser.add_argument('--eval_feat_path',     default='./feat_evaLib/iter500/pool6_lda',help='')
      parser.add_argument('--name_flag',          default='pool6_lda_Lib_top1',help='such as 68_v1_10000')
      parser.add_argument('--distance_pkl_path',   default='./result/dis/distance_pkl_',help='')
