...
def write2txt(save_csv_path,name_flag='',pickled_img_pkl_path=None,save_result_txt=None):
    ...
    txt.write(name_flag)
    txt.write('|')
    txt.write(str(value_p_ali_ap))
    txt.write('|')
    txt.write(str(value_not_p_ali_ap))
    txt.write('|')
    txt.write(str(value_ali_ap_all))

    txt.write('|')
    txt.write(str(value_p_top_ap))
    txt.write('|')
    txt.write(str(value_not_p_top_ap))
    txt.write('|')
...
if __name__ =='__main__':
    def parse_args():
      ...
      parser.add_argument('--base_path_name',     default='/data1/qtang/samsung/part_train/result/new_fc6weights/ap',help='')
      parser.add_argument('--pkl_path',           default='/data1/qtang/samsung/part_train/result/new_fc6weights/pkl',help='')
      parser.add_argument('--query_txt_path',     default='/data1/qtang/samsung/part_train/query_gt_33.txt',help='')
      parser.add_argument('--pickled_img_pkl_path',default='/data1/zwshen/samsung/intermediate/33_pickled_img.pkl',help='')
      parser.add_argument('--query_feat_path',    default='/data1/qtang/samsung/part_train/feat_query33ali/new_fc6weights/iter8000/fc7',help='')
      parser.add_argument('--eval_feat_path',     default='/data1/qtang/samsung/part_train/feat_eva33ali298/new_fc6weights/iter8000/fc7',help='')
      parser.add_argument('--name_flag',          default='iter8000_ali298_fc7',help='such as 68_v1_10000')
      parser.add_argument('--distance_pkl_path',   default='/data1/qtang/samsung/part_train/result/distance_pkl_',help='')
      parser.add_argument('--save_result_txt',     default='result_33_298.txt',help='such as result.txt') 
