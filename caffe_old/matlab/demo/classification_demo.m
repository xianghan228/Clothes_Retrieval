function [scores, maxlabel,transformed_im] = classification_demo(im, use_gpu)
% [scores, maxlabel] = classification_demo(im_data_bim, use_gpu)
%
...
%b = net.blobs('conv1').get_data()
c2 = net.blobs('data').get_data()
a = net.blobs('fc7').get_data()
%b(20,20,77)
[l1,l2] = max(a)
%[l3,l4] = max(b)
%a(106)
%net.params('fc7',1).get_data()
