name  = load('/media/data_2/alibaba/kmeans/name/name4.mat');
fea = load('/media/data_2/alibaba/kmeans/vgg/For_XiaoLu/For_XiaoLu/4.mat');
name = (name.str_)';
size(name)
arr_ = fea.class4;
size(arr_);
...
tic;
[IDX,C,sumd,D] = kmeans(arr_,50,'dist','sqEuclidean','rep',1,'Options',opts);
