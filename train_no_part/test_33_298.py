...
if __name__ =='__main__':
    def parse_args():
      ...
      parser.add_argument('--base_path_name',     default='/data1/qtang/samsung/train_no_part/result/ap',help='')
      parser.add_argument('--pkl_path',           default='/data1/qtang/samsung/train_no_part/result/pkl',help='')
      parser.add_argument('--query_txt_path',     default='/data1/qtang/samsung/train_no_part/query_gt_33.txt',help='')
      parser.add_argument('--pickled_img_pkl_path',default='/data1/zwshen/samsung/intermediate/33_pickled_img.pkl',help='')
      parser.add_argument('--query_feat_path',    default='/data1/qtang/samsung/train_no_part/feat_query33ali/iter2000/fc7_n',help='')
      parser.add_argument('--eval_feat_path',     default='/data1/qtang/samsung/train_no_part/feat_eva33ali298/iter2000/fc7_n',help='')
      parser.add_argument('--name_flag',          default='iter2000_ali298_fc7_n_eva298',help='such as 68_v1_10000')
      parser.add_argument('--distance_pkl_path',   default='/data1/qtang/samsung/train_no_part/result/dis/distance_pkl_',help='')
