...
class DataProvider:
  ...
  def read_imgs(self):
    ...
    for line in f.readlines():
      ...
      img_dict[line.strip().split()[0]]['img_name']=line.strip()
    return img_dict
  '''
  ...
  def get_batch_vec(self):
    ...
    while counter<self.batchsize:
      ...
      img_np_indx = img_np_indx-[104.007,  116.669,  122.679]
      ...
      img_name.append(self.img_dict[self.img_list[self.batch_index]]['img_name'])
